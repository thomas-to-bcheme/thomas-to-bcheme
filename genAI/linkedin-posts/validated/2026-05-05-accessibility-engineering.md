...
Hello World! Something I've been focused on lately is improving accessibility across my portfolio, and what I've learned is that accessibility isn't a checklist—it's a design constraint that improves UX for everyone when applied thoughtfully.
...
At this time, I am actively interviewing for AI/ML Engineering roles as my longitudinal career. I believe the opportunity cost is better spent reinforcing fundamentals of machine learning, deep learning, and system design. If I pass initial screenings, I'm preparing for interviews which may include takehome assignments, LeetCode-style questions, and system design discussions.
...
#Frontend #OpenToWork #Accessibility #WebDevelopment
