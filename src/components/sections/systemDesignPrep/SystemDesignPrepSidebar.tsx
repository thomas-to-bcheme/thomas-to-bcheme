...
import { Compass, ListChecks, Brain, MessagesSquare, BookOpen } from 'lucide-react';
 ...
 * scripts, + 4 framework steps + 6 ML framework steps + 6 question
 * categories + 6 reference sections), drives which link is highlighted.
