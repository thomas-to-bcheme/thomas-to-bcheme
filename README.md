...
skills/medium/SKILL.md                                .claude/skills/linkedin/
                                                           ↓
                                                      genAI/linkedin/drafts/ → linkedin-content-cicd
```
...
```
agentic-writer                  linkedin-content-cicd              LinkedIn
/linkedin skill ──→ drafts/ ──→ validated/ → not-posted/ ──→ LinkedIn Marketing API
/medium skill   ──→ drafts/                                  (weekday cron schedule)
                                     ↑
                              token-expiry-check.yml → Gmail alerts + GitHub issues
```
